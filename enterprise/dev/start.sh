...
export PRECISE_CODE_INTEL_INDEX_QUEUE_URL=http://localhost:3189
export PRECISE_CODE_INTEL_EXTERNAL_URL=http://localhost:3080
export PRECISE_CODE_INTEL_EXTERNAL_URL_FROM_DOCKER=http://localhost:3080
...
export ENTERPRISE_ONLY_COMMANDS=" precise-code-intel-bundle-manager precise-code-intel-index-agent precise-code-intel-index-queue precise-code-intel-worker "
